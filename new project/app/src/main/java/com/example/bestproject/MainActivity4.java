...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        food_three f1 = new food_three("كيك أوريو ","10","menuts",R.drawable.ceak_oryou_thre);
        food_three f2 = new food_three(" كيك لوتس","10","menuts",R.drawable.ceake_lotes_three);
        food_three f3 = new food_three("فطيره التفاح","10","menuts",R.drawable.fatera_atafah_three);
        food_three f4 = new food_three("krap","10","menuts",R.drawable.creap_three);
        food_three f5 = new food_three("كرات البسكوت","5","menuts",R.drawable.korat_albaskot_three);
        food_three f6 = new food_three("كوكيز","10","menuts",R.drawable.kokiz_three);
        food_three f7 = new food_three("جيس كيك","20","menuts",R.drawable.gees_kack_three);
